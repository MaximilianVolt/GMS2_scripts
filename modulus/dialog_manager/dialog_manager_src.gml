...
enum DIALOG_RUNNER // Should not edit
{
  ...
  __BITMASK_STATUS_EXECUTED_SHIFT = DIALOG_RUNNER.__BITMASK_STATUS_MAINTAINED_SHIFT + DIALOG_RUNNER.__BITMASK_STATUS_MAINTAINED_COUNT,
  __BITMASK_FLAG_INDEX_STATUS_EXECUTED_JUMP = DIALOG_RUNNER.__BITMASK_STATUS_EXECUTED_SHIFT,
  ...
  __BITMASK_STATUS_EXECUTED_COUNT = DIALOG_RUNNER.__BITMASK_FLAG_INDEX_STATUS_EXECUTED_CHOICE - DIALOG_RUNNER.__BITMASK_STATUS_EXECUTED_SHIFT + 1,
  FLAG_STATUS_COUNT = DIALOG_RUNNER.__BITMASK_STATUS_EXECUTED_SHIFT + DIALOG_RUNNER.__BITMASK_STATUS_EXECUTED_COUNT,
  ...
  __BITMASK_STATUS_EXECUTED_MASK = ((1 << DIALOG_RUNNER.__BITMASK_STATUS_EXECUTED_COUNT) - 1) << DIALOG_RUNNER.__BITMASK_STATUS_EXECUTED_SHIFT,
  ...
  static advance = function(shift = 1, jump_settings = DIALOG_RUNNER.JUMP_SETTING_TYPE_RELATIVE, prev_position = self.position, argv = undefined)
  {
    ...
    var current_scene_idx = manager.__decode_scene_idx(prev_position)
      ...
      , target_position = __resolve(
          resolved.position,
          prev_position,
          jump_settings & DIALOG_RUNNER.__BITMASK_JUMP_SETTINGS_BEHAVIOUR_MASK | DIALOG_RUNNER.JUMP_SETTING_BYPASS_FX_ON_ENTER * ((resolved.status & DIALOG_RUNNER.__BITMASK_STATUS_MAINTAINED_MASK) != 0),
          argv
        )
